...
public class LSettingItem extends RelativeLayout {
    ...
    public void getCustomStyle(Context context, AttributeSet attrs) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            if (attr == R.styleable.LSettingView_leftText) {
                ...
                RelativeLayout.LayoutParams layoutParams = (RelativeLayout.LayoutParams) mIvLeftIcon.getLayoutParams();
    ...
    private void initView(Context context) {
        mView = View.inflate(context, R.layout.item_setting, this);
    ...
    public void setRightCheckIconSize(Context context, int rightCheckIconSize) {
        rightCheckIconSize = dp2px(context, rightCheckIconSize);
        FrameLayout.LayoutParams layoutParams = (FrameLayout.LayoutParams) mRightIcon_check.getLayoutParams();
        layoutParams.width = rightCheckIconSize;
        layoutParams.height = rightCheckIconSize;
        mRightIcon_check.setLayoutParams(layoutParams);
    }
